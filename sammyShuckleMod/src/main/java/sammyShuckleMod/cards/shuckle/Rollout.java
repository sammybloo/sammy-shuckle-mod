...
public class Rollout extends CustomCard {
    ...
    public static final String ID = DefaultMod.makeID(Rollout.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(
                new ApplyPowerAction(p, p, new StrengthPower(p, baseMagicNumber)));
        AbstractDungeon.actionManager.addToBottom(
                new ApplyPowerAction(p, p, new LoseStrengthPower(p, baseMagicNumber)));
        AbstractDungeon.actionManager.addToBottom(
                new MakeTempCardInHandAction(this.makeStatEquivalentCopy())
                );
    }
