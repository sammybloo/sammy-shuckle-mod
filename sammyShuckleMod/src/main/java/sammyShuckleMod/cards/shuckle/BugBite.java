...
public class BugBite extends CustomCard {
    ...
    public static final String ID = DefaultMod.makeID(BugBite.class.getSimpleName());
    ...
    public BugBite() {
        ...
        baseDamage = DAMAGE;
        baseMagicNumber = STRENGTH_INCREASE;
    }
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom( // The action managed queues all the actions a card should do.
                ...
                new BugBiteAction(m, p, new DamageInfo(p, damage, damageTypeForTurn), magicNumber));
    }
